...
* [Added] Add update method for Account 
* [Added] Add destroy method for Link 
* [Added] Add Card.retrieve(customer_id, card_id) method 
* [Added] Add testing for 3.9 
* [Removed] Remove testing for 3.5 (EOL) 
...
This version adds support for configuring Qbmonetary API version via Qbmonetary.api_version` settings. If this version is set, it will be used instead of the one setting in your Qbmonetary account.

* [Added] Add API versioning support.

## [0.2.1] - 2015-08-03

This version is a maintenance release which updates the bundled CA certificate file to latest version. The old CA certificate will no longer be able to connect with Qbmonetary API by August 18th, 2015. There is no added APIs or behavior changes in this release.
